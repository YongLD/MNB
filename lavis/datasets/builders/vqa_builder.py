...
from lavis.datasets.datasets.ner_vqa_datasets import MNRVQADataset
...
@registry.register_builder("mnr_vqa")
class MNRVQABuilder(BaseDatasetBuilder):
    train_dataset_cls = MNRVQADataset
    DATASET_CONFIG_DICT = {"default": "configs/datasets/mnr/defaults_vqa.yaml"}
